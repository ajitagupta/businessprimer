...
A Cost-Benefit Analysis is conducted to examine potential changes to the business: before making a business decision evaluate the total costs and benefits to ensure to spend money effectively. To that effect it is advisable t operate in markets where there is high Pricing Power (ability to raise prices over time) and Lifetime Value (value of a customer over the entire relationship span, extended e.g. through Subscriptions).
